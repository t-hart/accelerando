...
Accelerando.Game.prototype = {
	...
	update: function() {
		...
		if(_gameOver){
			if(!_popUpShown){
				if(_score<0){
					var graphics = this.game.add.sprite((this.world.width/2)-400, (this.world.height/2)-200, 'lose_popup');
					var button1 = this.game.add.button(this.game.world.centerX+100,this.game.world.centerY+50,'main_menu',this.goToMainMenu,this);
					var button2 = this.game.add.button(this.game.world.centerX+100,this.game.world.centerY-50,'play_again',this.playAgain,this);
				}
